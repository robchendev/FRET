...
* DBmanager <br>
ID of a role. Anyone with this role will be able to use F.R.E.T.'s mod commands
* serverGuild <br>
ID of your discord server
* promoChannel <br>
ID of the channel promo.js passively runs in
* helpForumChannel <br>
ID of the channel where forum.js passively runs in can be invoked
* impersonateChannel <br>
ID of the channel that forwards messages to targeted channels
* weeklyGuideChannel <br>
